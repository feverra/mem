    ...
    <main>
                            ...
                            <div class="carousel-item w-100  active ">
                                <div class="row text-center">
                                    ...
                                    <div class="card loginfm shadow-sm card-radius" id="card">
                                        <div class="flip-card" name="5123510819887590">
                                                        ...
                                                        <div class="d-none d-md-block">
                                                            <div class="row" style="position: relative;bottom: 270px;">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="timecout-d" name="d-5123510819887590" id="countdown-canvas-5123510819887590">
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-2">
                                                                    <div class="col-6">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="text-end" style="position: relative;bottom: -10px;">
                                                                        <span id="clock-d-5123510819887590"></span>
                                                                        <span>21/07/2024</span>
                                                                    </div>
                                                                    <script>
                                                                        ct[card_id] = new CanvasCircularCountdown(document.getElementById('countdown-canvas-' + 5123510819887590), {
                                                                            duration: 100 * 1000,
                                                                            radius: 40,
                                                                            progressBarWidth: 10,
                                                                            progressBarOffset: 0,
                                                        ...
                                                        <div class="d-block d-md-none">
                                                            <div class="row" style="position: relative;bottom: 140px;">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="timecout-m" name="m-5123510819887590" id="countdown-canvas-mb-5123510819887590">
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="text-end" style="position: relative;bottom: 5px;font-size:10px;">
                                                                        <span id="clock-m-5123510819887590"></span>
                                                                        <span>21/07/2024</span>
                                                                    </div>
                                                                    <script>
                                        ...
                                        <div>
                                            <div class="card-body">
                                                ...
                                                <div class="row d-flex justify-content-center mt-1">
                                                    ...
                                                    <div class="col-12 ">
                                                        <h6 class="fw-bold">MK BLACK CARD</h6>
                                                    </div>
                                                    <div class="row g-1 d-flex justify-content-center" style="margin-top:-12px;">
                                                        <div class="col-7 col-md-4 col-lg-3 col-xl-2 my-auto">
                                                            <div class="progress" style="height: 10px;background-color: #c2c2c2;">
                                                                <div class="progress-bar bg-danger" role="progressbar" style="width: 26%;" aria-valuenow="26" aria-valuemin="0" aria-valuemax="100">26%</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto">
                                                            <img src="https://www.thisismymk.com/imgs/mk/up_black.png" width="80">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row d-flex justify-content-center" style="margin-top:-10px;">
                                                    <div style="font-size: 15px;">
                                                        คะแนนปรับระดับสะสม <span class="txt-red" style="font-size: 20px;">125</span>/480 คะแนน
                                                    </div>
                                                ...
                                                <div class="mx-auto detail-profile" style="width: 20rem; font-size:13px;">
                                                    <div class="text-start mx-1 my-2">
                                                        <div style="margin-left:8px;">
                                                            หมายเลขบัตรสมาชิก: <span class="txt-red"> 5123510819887590 </span>
                                                        </div>
                                                        <div style="margin-left:8px;">
                                                            บัตรสมาชิกหมดอายุ: <span class="txt-red"> 31/12/2024 </span>
                                                        </div>
                                                        <div style="margin-left:8px;">
                                                            คะแนนสะสมวันนี้: <span class="txt-red"> 0 </span> คะแนน </div>
                                                        <div style="margin-left:8px;">
                                                            คะแนนแลกของรางวัล: <span class="txt-red"> 125 </span> คะแนน </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                var txt = 'CARD_NO:5123510819887590|EXP:31/12/2024|DISC_RATE:CA10,CR5'
                var qrcode = QRCode({
                    msg: txt,
                    dim: 150,
                    pad: 0,
